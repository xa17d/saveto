...
fun extensionByMime(mime: Mime): String {
    val extension = mimeExtensionMap[mime]
...
val mimeExtensionMap by lazy {
    val result = HashMap<Mime, String>()

    fun add(mime: String, extension: String) {
        result.putIfAbsent(Mime(mime), extension)
    }

    // Source: http://androidxref.com/4.4.4_r1/xref/libcore/luni/src/main/java/libcore/net/MimeUtils.java
